...
{
    // <Set Fan PWM>
    ipmi_register_callback(netFnSv310g4OEM2, CMD_SET_FAN_PWM, NULL,
                           IpmiSetPwm, PRIVILEGE_USER);

    // <Set FSC Mode>
    ipmi_register_callback(netFnSv310g4OEM2, CMD_SET_FSC_MODE, NULL,
                           IpmiSetFscMode, PRIVILEGE_USER);

    // <Get FSC Mode>
    ipmi_register_callback(netFnSv310g4OEM2, CMD_GET_FSC_MODE, NULL,
